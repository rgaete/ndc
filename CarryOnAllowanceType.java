...
@XmlType(name = "CarryOnAllowanceType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "carryOnBag"
})
@XmlSeeAlso({
    CarryOnBags.class
...
public class CarryOnAllowanceType {
    ...
    @XmlElement(name = "CarryOnBag", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
