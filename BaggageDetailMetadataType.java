...
@XmlType(name = "BaggageDetailMetadataType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "attributes",
    "fareTariff",
    "fareRule",
    "fareCat"
    ...
    extends MetadataObjectBaseType
{
    ...
    @XmlElement(name = "FareTariff", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected BaggageDetailMetadataType.FareTariff fareTariff;
    @XmlElement(name = "FareRule", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected String fareRule;
    @XmlElement(name = "FareCat", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
