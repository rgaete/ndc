...
@XmlType(name = "EnabledSystemType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "systemID"
})
@XmlSeeAlso({
    ...
    extends IntermediaryCoreRepType
{
    ...
    @XmlElement(name = "SystemID", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
