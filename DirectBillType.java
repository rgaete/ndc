...
@XmlType(name = "DirectBillType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "directBillID",
    "companyName",
    "contactName",
    "address"
...
public class DirectBillType {
    ...
    @XmlElement(name = "DirectBillID", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected String directBillID;
    @XmlElement(name = "CompanyName", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected String companyName;
    @XmlElement(name = "ContactName", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    ...
    public static class Address {
        ...
        @XmlElement(name = "StructuredAddress", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
        protected StructuredAddrType structuredAddress;
        @XmlElement(name = "SimpleAddress", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
        protected SimpleAddrType simpleAddress;
        @XmlElement(name = "PaymentAddress", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
