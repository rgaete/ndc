...
@XmlType(name = "ReferencePointQueryType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "referencePoints",
    "proximity"
})
public class ReferencePointQueryType {

    @XmlElement(name = "ReferencePoints", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected ReferencePointQueryType.ReferencePoints referencePoints;
    @XmlElement(name = "Proximity", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    ...
    public static class Proximity {
        ...
        @XmlElement(name = "ReferencePoint", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
        protected ReferencePointQueryType.Proximity.ReferencePoint referencePoint;
        @XmlElement(name = "Application", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
        protected String application;
        @XmlElement(name = "AreaValue", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
