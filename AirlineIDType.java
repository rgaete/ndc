...
@XmlType(name = "AirlineID_Type", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "value"
})
@XmlSeeAlso({
    ndc.BookingReferenceType.AirlineID.class,
    ndc.SecurePaymentPaxInfoType.Carriers.Carrier.class,
    ndc.CarrierFeeInfoType.CarrierFees.Fee.AirlineID.class,
    ndc.AirlineID.class
})
