...
@XmlType(name = "OfferIncentiveType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "incentive"
})
@XmlSeeAlso({
    ndc.OfferItemMetadataType.Incentives.class
})
public class OfferIncentiveType {

    @XmlElement(name = "Incentive", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
    ...
    public static class Incentive {
        ...
        @XmlElement(name = "OfferCodeID", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
        protected String offerCodeID;
        @XmlElement(name = "ExpirationDate", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
        protected OfferIncentiveType.Incentive.ExpirationDate expirationDate;
        @XmlElement(name = "OfferSubCode", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
        protected OfferIncentiveType.Incentive.OfferSubCode offerSubCode;
        @XmlElement(name = "AvailableUnits", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
        @XmlSchemaType(name = "positiveInteger")
        protected BigInteger availableUnits;
        @XmlElement(name = "DiscountLevel", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
