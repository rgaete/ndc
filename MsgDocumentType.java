...
@XmlType(name = "MsgDocumentType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "metadata",
    "name",
    "referenceVersion"
})
public class MsgDocumentType {
    ...
    @XmlElement(name = "ReferenceVersion", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
