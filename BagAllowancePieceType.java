...
@XmlType(name = "BagAllowancePieceType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "applicableParty",
    "totalQuantity",
    "bagType",
    "applicableBag",
...
public class BagAllowancePieceType {
    ...
    @XmlElement(name = "ApplicableParty", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
    protected String applicableParty;
    @XmlElement(name = "TotalQuantity", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
    protected BigInteger totalQuantity;
    @XmlElement(name = "BagType", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    ...
    @XmlElement(name = "PieceMeasurements", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
    ...
    public static class PieceMeasurements {
        ...
        @XmlElement(name = "PieceWeightAllowance", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
        protected List<BagAllowanceWeightType> pieceWeightAllowance;
        @XmlElement(name = "PieceDimensionAllowance", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
