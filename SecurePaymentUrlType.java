...
@XmlType(name = "SecurePaymentUrlType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "acsurl",
    "failURL",
    "merchantURL",
    "termURL"
...
@XmlSeeAlso({
    ndc.SecurePaymentAlertType.URLs.class
})
public class SecurePaymentUrlType {

    @XmlElement(name = "ACS_URL", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    @XmlSchemaType(name = "anyURI")
    protected String acsurl;
    @XmlElement(name = "FailURL", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    @XmlSchemaType(name = "anyURI")
    protected String failURL;
    @XmlElement(name = "MerchantURL", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    @XmlSchemaType(name = "anyURI")
    protected String merchantURL;
    @XmlElement(name = "TermURL", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    @XmlSchemaType(name = "anyURI")
