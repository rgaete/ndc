...
@XmlType(name = "CorePeriodGrpType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "date",
    "dateTime",
    "timeStamp"
})
@XmlSeeAlso({
    ndc.PolicyType.Metadata.ValidPeriod.class
})
public class CorePeriodGrpType {
    ...
    @XmlElement(name = "DateTime", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
