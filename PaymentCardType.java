...
@XmlType(name = "PaymentCardType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "cardType",
    "cardCode",
    "cardNumber",
    "issueNumber",
...
public class PaymentCardType {
    ...
    @XmlElement(name = "CardCode", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected String cardCode;
    @XmlElement(name = "CardNumber", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected PaymentCardType.CardNumber cardNumber;
    @XmlElement(name = "IssueNumber", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected Integer issueNumber;
    @XmlElement(name = "SeriesCode", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected PaymentCardType.SeriesCode seriesCode;
    @XmlElement(name = "CardHolderName", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected PaymentCardType.CardHolderName cardHolderName;
    @XmlElement(name = "CardIssuerName", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected PaymentCardType.CardIssuerName cardIssuerName;
    @XmlElement(name = "CardHolderBillingAddress", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected PaymentCardType.CardHolderBillingAddress cardHolderBillingAddress;
    @XmlElement(name = "MaskedCardNumber", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    ...
    @XmlElement(name = "EffectiveExpireDate", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected PaymentCardType.EffectiveExpireDate effectiveExpireDate;
    @XmlElement(name = "AddressValidation", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected String addressValidation;
    @XmlElement(name = "TokenizedCardNumber", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected String tokenizedCardNumber;
    @XmlElement(name = "ApprovalType", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    ...
    public static class CardIssuerName {
        ...
        @XmlElement(name = "BankID", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
