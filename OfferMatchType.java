...
@XmlType(name = "OfferMatchType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "application",
    "matchResult",
    "percentage"
})
public class OfferMatchType {
    ...
    @XmlElement(name = "MatchResult", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
