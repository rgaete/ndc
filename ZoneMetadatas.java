...
@XmlRootElement(name = "ZoneMetadatas", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
public class ZoneMetadatas {

    @XmlElement(name = "ZoneMetadata", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
