...
@XmlType(name = "TransferPreferencesType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "connection",
    "pricing"
})
public class TransferPreferencesType {

    @XmlElement(name = "Connection", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
    ...
    public static class Connection {
        ...
        @XmlElement(name = "Codes", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
        protected TransferPreferencesType.Connection.Codes codes;
        @XmlElement(name = "MaxNumber", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
        @XmlSchemaType(name = "positiveInteger")
        protected BigInteger maxNumber;
        @XmlElement(name = "MaxTime", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
        protected Duration maxTime;
        @XmlElement(name = "MinTime", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
        protected Duration minTime;
        @XmlElement(name = "Interline", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
