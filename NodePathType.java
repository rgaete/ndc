...
@XmlType(name = "NodePathType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "path",
    "tagName"
})
@XmlSeeAlso({
    ndc.PolicyType.Nodes.Node.class
})
public class NodePathType {

    @XmlElement(name = "Path", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
    protected NodePathType.Path path;
    @XmlElement(name = "TagName", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
