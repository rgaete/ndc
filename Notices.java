...
@XmlRootElement(name = "Notices", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
public class Notices {

    @XmlElement(name = "Notice", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
    ...
    public static class Notice {
        ...
        @XmlElement(name = "TaxExemptionNotice", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
        protected TaxExemptionNoticeType taxExemptionNotice;
        @XmlElement(name = "ServiceFilterNotice", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
        protected ServiceFilterNoticeType serviceFilterNotice;
        @XmlElement(name = "PricingParametersNotice", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
        protected PricingParametersNoticeType pricingParametersNotice;
        @XmlElement(name = "PriceVarianceNotice", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
        protected PriceVarianceNotice priceVarianceNotice;
        @XmlElement(name = "PaymentRulesNotice", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
        protected PaymentRulesNoticeType paymentRulesNotice;
        @XmlElement(name = "InventoryGuaranteeNotif", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
