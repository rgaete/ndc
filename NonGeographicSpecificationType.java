...
@XmlType(name = "NonGeographicSpecificationType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "travelAgencyInd",
    "aggregatorID",
    "pointOfSaleCode"
})
public class NonGeographicSpecificationType {
    ...
    @XmlElement(name = "TravelAgencyInd", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected Boolean travelAgencyInd;
    @XmlElement(name = "AggregatorID", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected AggregatorIDType aggregatorID;
    @XmlElement(name = "PointOfSaleCode", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
