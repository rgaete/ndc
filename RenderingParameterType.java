...
@XmlType(name = "RenderingParameterType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "parameter"
})
@XmlSeeAlso({
    ndc.RenderingInstructionsType.Parameters.class
})
public class RenderingParameterType {

    @XmlElement(name = "Parameter", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
