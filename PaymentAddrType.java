...
@XmlType(name = "PaymentAddrType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "street",
    "poBox",
    "buildingRoom",
    "city",
...
public class PaymentAddrType {
    ...
    @XmlElement(name = "PO_Box", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected String poBox;
    @XmlElement(name = "BuildingRoom", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected String buildingRoom;
    @XmlElement(name = "City", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected PaymentAddrType.City city;
    @XmlElement(name = "StateProv", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected String stateProv;
    @XmlElement(name = "PostalCode", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected String postalCode;
    @XmlElement(name = "Country", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
