...
@XmlType(name = "SocialMediaQualifierType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "service",
    "user",
    "emailAddress"
})
...
public class SocialMediaQualifierType {
    ...
    @XmlElement(name = "User", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
