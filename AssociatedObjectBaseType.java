...
@XmlType(name = "AssociatedObjectBaseType", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
@XmlSeeAlso({
    ndc.BagListReqParamsType.ServiceFilters.class,
    ndc.BagListReqParamsType.Pricing.FeeExemption.class
})
