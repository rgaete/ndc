...
@XmlType(name = "TravelAgencyType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "agencyID"
})
@XmlSeeAlso({
    ...
    extends AgencyCoreRepType
{
    ...
    @XmlElement(name = "AgencyID", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
