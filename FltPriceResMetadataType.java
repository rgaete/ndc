...
@XmlType(name = "FltPriceResMetadataType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "shopping",
    "traveler",
    "other"
})
@XmlSeeAlso({
    ndc.FlightPriceRS.Metadata.class
})
public class FltPriceResMetadataType {
    ...
    @XmlElement(name = "Traveler", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
