...
@XmlType(name = "CouponTicketDocType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "ticketDocNbr",
    "type",
    "inConnectionDocNbr",
    "numberofBooklets",
...
public class CouponTicketDocType {
    ...
    @XmlElement(name = "NumberofBooklets", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
    protected BigInteger numberofBooklets;
    @XmlElement(name = "DateOfIssue", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar dateOfIssue;
    @XmlElement(name = "TimeOfIssue", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected String timeOfIssue;
    @XmlElement(name = "TicketingLocation", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected String ticketingLocation;
    @XmlElement(name = "RoutingDomIntCode", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected String routingDomIntCode;
    @XmlElement(name = "FeeOwner", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    ...
    @XmlElement(name = "CouponInfo", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected List<CouponInfoType> couponInfo;
    @XmlList
    @XmlElement(name = "PenaltyReferences", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    @XmlIDREF
    @XmlSchemaType(name = "IDREFS")
    protected List<Object> penaltyReferences;
    @XmlElement(name = "ReportingType", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
