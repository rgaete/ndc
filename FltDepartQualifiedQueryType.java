...
@XmlType(name = "FltDepartQualifiedQueryType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "locationCode",
    "date",
    "time",
    "leadPricing"
    ...
    extends KeyWithMetaObjectBaseType
{
    ...
    @XmlElement(name = "LocationCode", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
    protected List<FltDepartQualifiedQueryType.LocationCode> locationCode;
    @XmlElement(name = "Date", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar date;
    @XmlElement(name = "Time", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected String time;
    @XmlElement(name = "LeadPricing", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    ...
    public static class LeadPricing {
        ...
        @XmlElements({
            @XmlElement(name = "LeadDatePeriod", namespace = "http://www.iata.org/IATA/EDIST/2017.1", type = LeadDatePeriodType.class),
            @XmlElement(name = "LeadTimePeriod", namespace = "http://www.iata.org/IATA/EDIST/2017.1", type = LeadTimePeriodType.class)
        })
