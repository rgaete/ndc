...
@XmlType(name = "VoucherMethodType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "number",
    "effectiveExpireDate",
    "remainingValue"
})
public class VoucherMethodType {
    ...
    @XmlElement(name = "RemainingValue", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
