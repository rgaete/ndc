...
@XmlType(name = "TaxCouponInfoType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "ticketDocument"
})
public class TaxCouponInfoType {
    ...
    public static class TicketDocument {
        ...
        public static class CouponNumber {
            ...
            @XmlElement(name = "TaxCouponInfo", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
            protected TaxCouponInfoType.TicketDocument.CouponNumber.TaxCouponInfo taxCouponInfo;
            @XmlElement(name = "Tax", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
            protected List<TaxCouponInfoType.TicketDocument.CouponNumber.Tax> tax;
            @XmlElement(name = "UnticketedPointInfo", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
