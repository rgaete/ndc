...
@XmlType(name = "ServiceFilterType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "groupCode",
    "subGroupCode"
})
@XmlSeeAlso({
    ndc.ServiceFilterNoticeType.Results.AppliedFilters.AppliedFilter.class
})
public class ServiceFilterType {

    @XmlElement(name = "GroupCode", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
    protected ServiceFilterType.GroupCode groupCode;
    @XmlElement(name = "SubGroupCode", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
