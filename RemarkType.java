...
@XmlType(name = "RemarkType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "remark"
})
@XmlSeeAlso({
    ndc.PenaltyType.ApplicableFeeRemarks.class,
    ndc.PenaltyType.Details.Detail.Amounts.Amount.ApplicableFeeRemarks.class,
    InstrRemarkType.class
})
public class RemarkType {

    @XmlElement(name = "Remark", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
