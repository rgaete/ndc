...
@XmlType(name = "ListOfContentSourceType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "contentSource"
})
public class ListOfContentSourceType {

    @XmlElement(name = "ContentSource", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
    ...
    public static class ContentSource {
        ...
        @XmlElement(name = "NodePath", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
        protected String nodePath;
        @XmlElement(name = "AirlineID", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
        protected AirlineID airlineID;
        @XmlElement(name = "OtherID", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
