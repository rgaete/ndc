...
@XmlType(name = "DescriptionType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "text",
    "markupStyle",
    "link",
    "media"
...
@XmlSeeAlso({
    ndc.MarketingMessages.MarketMessage.class,
    ndc.MarketingInfoType.Message.class,
    ndc.ServiceDescriptionType.Description.class,
    ndc.Description.class
})
public class DescriptionType {

    @XmlElement(name = "Text", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected DescriptionType.Text text;
    @XmlElement(name = "MarkupStyle", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
