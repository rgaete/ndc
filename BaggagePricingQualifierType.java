...
@XmlType(name = "BaggagePricingQualifierType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "baggageOption",
    "requestAction",
    "optionalCharges"
})
public class BaggagePricingQualifierType {
    ...
    @XmlElement(name = "BaggageOption", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected List<String> baggageOption;
    @XmlElement(name = "RequestAction", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected String requestAction;
    @XmlElement(name = "OptionalCharges", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
