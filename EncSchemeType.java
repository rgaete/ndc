...
@XmlType(name = "EncSchemeType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "detail",
    "metadata"
})
@XmlSeeAlso({
    ndc.PolicyType.Metadata.EncodingScheme.class
})
public class EncSchemeType {
    ...
    public static class Detail {
        ...
        @XmlElement(name = "SupportedDomain", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
