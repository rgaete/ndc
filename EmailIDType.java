...
@XmlType(name = "EmailID_Type", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "value"
})
@XmlSeeAlso({
    ndc.EmailType.Address.class,
    ndc.SocialMediaQualifierType.EmailAddress.class
})
