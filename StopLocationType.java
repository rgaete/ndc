...
@XmlType(name = "StopLocationType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "stopLocation"
})
public class StopLocationType {
    ...
    public static class StopLocation {
        ...
        @XmlElement(name = "ArrivalDate", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
        @XmlSchemaType(name = "date")
        protected XMLGregorianCalendar arrivalDate;
        @XmlElement(name = "ArrivalTime", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
        protected String arrivalTime;
        @XmlElement(name = "DepartureDate", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
        @XmlSchemaType(name = "date")
        protected XMLGregorianCalendar departureDate;
        @XmlElement(name = "DepartureTime", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
        protected String departureTime;
        @XmlElement(name = "Equipment", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
        protected AircraftSummaryType equipment;
        @XmlElement(name = "GroundTime", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
