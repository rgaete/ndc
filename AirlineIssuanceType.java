...
@XmlType(name = "AirlineIssuanceType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "airlineName",
    "place"
})
@XmlSeeAlso({
...
public class AirlineIssuanceType {
    ...
    @XmlElement(name = "Place", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
