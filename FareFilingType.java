...
@XmlType(name = "FareFilingType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "baseAmount",
    "nucAmount",
    "exchangeRate",
    "ticketBulkMask",
...
public class FareFilingType {
    ...
    @XmlElement(name = "NUC_Amount", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected FareFilingType.NUCAmount nucAmount;
    @XmlElement(name = "ExchangeRate", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected String exchangeRate;
    @XmlElement(name = "TicketBulkMask", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected String ticketBulkMask;
    @XmlElement(name = "FiledFare", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
