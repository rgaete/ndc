...
@XmlType(name = "FlightDepartureType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "airportCode",
    "date",
    "time",
    "airportName",
...
public class FlightDepartureType {
    ...
    @XmlElement(name = "Date", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
