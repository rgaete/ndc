...
@XmlType(name = "InvDiscrepencyAlertType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "code",
    "associations",
    "alternateOffers",
    "remarks"
...
public class InvDiscrepencyAlertType {
    ...
    @XmlElement(name = "AlternateOffers", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    ...
    public static class AlternateOffers {
        ...
        @XmlElement(name = "TotalOfferQuantity", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
        ...
        @XmlElement(name = "AlternateOffer", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
            ...
            extends OfferType
        {
            ...
            @XmlElement(name = "AltBaggageOffer", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
            protected AltBaggageOfferType altBaggageOffer;
            @XmlElement(name = "AltOtherOffer", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
            protected AltOtherOfferType altOtherOffer;
            @XmlElement(name = "AltPricedFlightOffer", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
            protected AltPricedFlightOfferType altPricedFlightOffer;
            @XmlElement(name = "AltSeatOffer", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
