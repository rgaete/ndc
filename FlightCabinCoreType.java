...
@XmlType(name = "FlightCabin_CoreType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "cabinDesignator",
    "marketingName"
})
@XmlSeeAlso({
...
public class FlightCabinCoreType {
    ...
    @XmlElement(name = "CabinDesignator", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
