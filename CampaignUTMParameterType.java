...
@XmlType(name = "CampaignUTM_ParameterType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "otherUTM"
})
@XmlSeeAlso({
    ndc.CampaignReferralType.UTM.OtherUTMs.class
})
public class CampaignUTMParameterType {

    @XmlElement(name = "Other_UTM", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
