...
@XmlRootElement(name = "AdvanceTicketing", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
public class AdvanceTicketing {

    @XmlElement(name = "AdvanceReservation", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
    protected AdvanceTicketing.AdvanceReservation advanceReservation;
    @XmlElement(name = "AdvanceDeparture", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
