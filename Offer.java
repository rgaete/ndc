...
@XmlRootElement(name = "Offer", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
public class Offer {

    @XmlElements({
        @XmlElement(name = "DisclosureMetadatas", namespace = "http://www.iata.org/IATA/EDIST/2017.1", type = DisclosureMetadatas.class),
        @XmlElement(name = "OfferMetadatas", namespace = "http://www.iata.org/IATA/EDIST/2017.1", type = OfferMetadatas.class),
        @XmlElement(name = "OfferInstructionMetadatas", namespace = "http://www.iata.org/IATA/EDIST/2017.1", type = OfferInstructionMetadatas.class),
        @XmlElement(name = "OfferPenaltyMetadatas", namespace = "http://www.iata.org/IATA/EDIST/2017.1", type = OfferPenaltyMetadatas.class),
        @XmlElement(name = "OfferTermsMetadatas", namespace = "http://www.iata.org/IATA/EDIST/2017.1", type = OfferTermsMetadatas.class)
    })
