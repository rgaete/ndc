...
@XmlType(name = "AugPointInfoType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "augPoint",
    "lists"
})
public class AugPointInfoType {

    @XmlElement(name = "AugPoint", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
    protected List<AugPointType> augPoint;
    @XmlElement(name = "Lists", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
