...
@XmlType(name = "MediaAssocType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "mediaGroupreference",
    "mediaItems"
})
public class MediaAssocType {

    @XmlElement(name = "MediaGroupreference", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    @XmlIDREF
    @XmlSchemaType(name = "IDREF")
    protected Object mediaGroupreference;
    @XmlElement(name = "MediaItems", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    ...
    public static class MediaItems {
        ...
        @XmlElement(name = "MediaItemReference", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
        @XmlIDREF
        @XmlSchemaType(name = "IDREF")
