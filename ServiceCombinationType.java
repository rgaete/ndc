...
@XmlType(name = "ServiceCombinationType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "combination"
})
@XmlSeeAlso({
...
public class ServiceCombinationType {
    ...
    @XmlElement(name = "Combination", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
    ...
    public static class Combination {
        ...
        @XmlElement(name = "Rule", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
