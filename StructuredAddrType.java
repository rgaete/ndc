...
@XmlType(name = "StructuredAddrType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "application",
    "street",
    "buildingRoom",
    "poBox",
...
@XmlSeeAlso({
    ...
    ndc.PaymentCardType.CardHolderBillingAddress.class
})
public class StructuredAddrType {
    ...
    @XmlElement(name = "County", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
