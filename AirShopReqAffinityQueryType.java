...
@XmlType(name = "AirShopReqAffinityQueryType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "originDestination",
    "stayPeriodDateRange",
    "stayPeriodSeason",
    "tripDistance",
...
public class AirShopReqAffinityQueryType {
    ...
    @XmlElement(name = "StayPeriodDateRange", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected StayPeriodDateRangeType stayPeriodDateRange;
    @XmlElement(name = "StayPeriodSeason", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected StayPeriodSeasonType stayPeriodSeason;
    @XmlElement(name = "TripDistance", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected TravelDistancePreferencesType tripDistance;
    @XmlElement(name = "TripTime", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected TravelTimePreferencesType tripTime;
    @XmlElement(name = "Budget", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected AirShopReqAffinityQueryType.Budget budget;
    @XmlElement(name = "KeywordPreferences", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    ...
    public static class Budget {
        ...
        @XmlElement(name = "GroupBudget", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
        protected GroupBudgetType groupBudget;
        @XmlElement(name = "PerPersonBudget", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    ...
    public static class KeywordPreferences {
        ...
        @XmlElement(name = "KeywordPreference", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
        ...
        extends AssociatedObjectBaseType
    {
        ...
        @XmlElement(name = "AirportCityDeparture", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
        protected FltDepartQualifiedQueryType airportCityDeparture;
        @XmlElement(name = "CountryDeparture", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
        protected AffinityCountryDepartType countryDeparture;
        @XmlElement(name = "ReferencePointDeparture", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
        protected AffinityReferencePointDepartType referencePointDeparture;
        @XmlElement(name = "StateProvDeparture", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
        protected AffinityStateProvDepartType stateProvDeparture;
        @XmlElement(name = "AirportCityArrival", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
        protected FltArriveQualifiedQueryType airportCityArrival;
        @XmlElement(name = "CountryArrival", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
        protected AffinityCountryArriveType countryArrival;
        @XmlElement(name = "ReferencePointArrival", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
        protected AffinityReferencePointArriveType referencePointArrival;
        @XmlElement(name = "StateProvArrival", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
