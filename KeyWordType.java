...
@XmlType(name = "KeyWordType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "word",
    "value"
})
@XmlSeeAlso({
    ndc.StateProvQueryType.Keywords.KeyWord.class,
    ndc.KeyWord.class
})
public class KeyWordType {

    @XmlElement(name = "Word", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
