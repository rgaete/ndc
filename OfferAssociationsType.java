...
@XmlType(name = "OfferAssociationsType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "shopper",
    "flight",
    "priceClass",
    "bagDetails",
...
public class OfferAssociationsType {
    ...
    @XmlElement(name = "Media", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    ...
    public static class Services {
        ...
        public static class Service {
            ...
            @XmlList
            @XmlElement(name = "ServiceReferences", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
            @XmlIDREF
