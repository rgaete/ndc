...
@XmlType(name = "FltPriceReqMetadataType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "shopping",
    "passenger",
    "other"
})
@XmlSeeAlso({
    ndc.FlightPriceRQ.Metadata.class
})
public class FltPriceReqMetadataType {
    ...
    public static class Other {
        ...
        public static class OtherMetadata {
            ...
            @XmlElement(name = "ContentMetadatas", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
