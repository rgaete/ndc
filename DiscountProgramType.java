...
@XmlType(name = "DiscountProgramType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "account",
    "assocCode",
    "name"
})
public class DiscountProgramType {
    ...
    @XmlElement(name = "Account", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
    protected DiscountProgramType.Account account;
    @XmlElement(name = "AssocCode", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
