...
@XmlType(name = "CodesetType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "code",
    "definition",
    "tableName",
    "link"
...
@XmlSeeAlso({
    ndc.SeatLocationType.Characteristics.Characteristic.class,
    ndc.AlliancePreferencesType.Alliance.class,
    ndc.FlightPreferencesType.Aircraft.Seats.Position.class,
    ndc.PointOfSaleType.TouchPoint.Device.class,
    AircraftCabinType.class,
    ndc.DeviceType.Type.class,
    CabinType.class
})
public class CodesetType {
    ...
    @XmlElement(name = "Definition", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected String definition;
    @XmlElement(name = "TableName", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
