...
@XmlRootElement(name = "FlightPriceRS", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
public class FlightPriceRS {
    ...
    @XmlElement(name = "PricedFlightOffers", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    protected FlightPriceRS.PricedFlightOffers pricedFlightOffers;
    @XmlElement(name = "AirlineOffers", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    ...
    public static class AirlineOffers {
        ...
        @XmlElement(name = "AirlineOffer", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
            ...
            extends OfferType
        {
            ...
            @XmlElement(name = "PricedOffer", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
    ...
    public static class PricedFlightOffers {
        ...
        @XmlElement(name = "PricedFlightOffer", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
