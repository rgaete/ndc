...
@XmlType(name = "FlightItemOfferType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "pricing",
    "flight",
    "aircraftEquipment",
    "fareDetail",
...
public class FlightItemOfferType {
    ...
    @XmlElement(name = "AircraftEquipment", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    ...
    public static class AircraftEquipment {
        ...
        @XmlElement(name = "AirlineEquipCode", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
    ...
    public static class Passengers {
        ...
        @XmlElement(name = "GroupReference", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
        @XmlIDREF
