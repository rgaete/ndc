...
@XmlType(name = "FltSegmentMaxTimePreferencesType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "maxFlightTime"
})
public class FltSegmentMaxTimePreferencesType {

    @XmlElement(name = "MaxFlightTime", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
    ...
    public static class MaxFlightTime {
        ...
        @XmlElement(name = "TimeAmount", namespace = "http://www.iata.org/IATA/EDIST/2017.1", required = true)
