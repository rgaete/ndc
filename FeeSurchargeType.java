...
@XmlType(name = "FeeSurchargeType", namespace = "http://www.iata.org/IATA/EDIST/2017.1", propOrder = {
    "total",
    "breakdown"
})
@XmlSeeAlso({
    ndc.GenericPriceType.Fees.class,
    ndc.SettlementType.Fees.class,
    ndc.DetailCurrencyPriceType.Fees.class,
    ndc.OfferPriceLeadDetailType.PriceDetail.Fees.class,
    ndc.FeeDisclosureType.Fees.class,
    ndc.FlightPriceType.Fees.class
})
public class FeeSurchargeType {
    ...
    public static class Breakdown {
        ...
        public static class Fee {
            ...
            @XmlElement(name = "Designator", namespace = "http://www.iata.org/IATA/EDIST/2017.1")
